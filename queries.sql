...
insert into lot(lot_id, date_start, lot_name, description_lot, image, start_price, date_end, step_bet, categories_id, user_id, user_id) values
...
select * from lot c join categories u on c.categories_id = u.categories_id
    where id = 1;
